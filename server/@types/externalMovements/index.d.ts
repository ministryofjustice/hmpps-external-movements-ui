...
export interface paths {
  ...
  '/prisons/{prisonCode}/temporary-absence-locations': {
    parameters: {
      query?: never
      header?: never
      path?: never
     ...
     *     * ROLE_EXTERNAL_MOVEMENTS__EXTERNAL_MOVEMENTS_UI
     */
    get: operations['getPrisonTapLocations']
    /**
     * @description Requires one of the following roles:
     *     * ROLE_EXTERNAL_MOVEMENTS__EXTERNAL_MOVEMENTS_UI
     */
    put: operations['setPrisonTapLocations']
    post?: never
    delete?: never
    options?: never
    head?: never
  ...
  '/temporary-absence-authorisations/{id}/occurrences': {
     ...
     *     * ROLE_EXTERNAL_MOVEMENTS__EXTERNAL_MOVEMENTS_UI
     */
    post: operations['createOccurrences']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/prisons/{prisonCode}/external-movements/overview': {
    parameters: {
      query?: never
      header?: never
      path?: never
  ...
  schemas: {
    ...
    AuthorisationActions: {
      actions: (
        ...
        | components['schemas']['CreateOccurrences']
    ...
    ReferenceIds: {
      ids: components['schemas']['ReferenceId'][]
      /** Format: uuid */
      id: string
    }
...
export interface operations {
  ...
  getPrisonTapLocations: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          '*/*': components['schemas']['TapLocations']
        }
      }
    }
  }
  setPrisonTapLocations: {
    parameters: {
      query?: never
      header?: never
      path: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['TapLocations']
      }
    }
    responses: {
  ...
  createOccurrences: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['CreateOccurrencesRequest']
      }
    }
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          '*/*': components['schemas']['ReferenceIds']
        }
      }
    }
  }
