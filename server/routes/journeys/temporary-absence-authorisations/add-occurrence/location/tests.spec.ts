...
test.describe('/temporary-absence-authorisations/add-occurrence/location unauthorised', () => {
  test('should show unauthorised error', async ({ page }) => {
    await testNotAuthorisedPage(page, `/${uuidV4()}/temporary-absence-authorisations/add-occurrence/location`)
  })
})

test.describe('/temporary-absence-authorisations/add-occurrence/location', () => {
  ...
  const startJourney = async (page: Page, journeyId: string) => {
    ...
    await page.goto(`/${journeyId}/temporary-absence-authorisations/add-occurrence/location`)
  }

  test('should search and select a UK address and proceed to comments page', async ({ page }) => {
  ...
  test('should search and select a location and proceed to comments page', async ({ page }) => {
    const journeyId = uuidV4()
    await startJourney(page, journeyId)
  ...
  test('should enter an address and proceed to comments page', async ({ page }) => {
    const journeyId = uuidV4()
    await startJourney(page, journeyId)
  ...
  test('should enter an area and proceed to comments page', async ({ page }) => {
    const journeyId = uuidV4()
    await startJourney(page, journeyId)
