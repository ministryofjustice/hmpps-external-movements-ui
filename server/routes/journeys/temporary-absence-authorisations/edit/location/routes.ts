import { EditTapAuthorisationLocationController } from './controller'
...
export const EditTapAuthorisationLocationRoutes = ({ osPlacesAddressService, externalMovementsService }: Services) => {
  const { router, get, post } = BaseRouter()
  const controller = new EditTapAuthorisationLocationController(externalMovementsService)
