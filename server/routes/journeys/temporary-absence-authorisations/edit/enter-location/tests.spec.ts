...
import { EditTapAuthorisationEnterLocationPage } from './test.page'
import { testNotAuthorisedPage } from '../../../../../../integration_tests/steps/testNotAuthorisedPage'

test.describe('/temporary-absence-authorisations/edit/enter-location unauthorised', () => {
  test('should show unauthorised error', async ({ page }) => {
    await testNotAuthorisedPage(page, `/${uuidV4()}/temporary-absences/edit/enter-location`)
  })
})

test.describe('/temporary-absence-authorisations/edit/enter-location', () => {
  ...
  const startJourney = async (page: Page, journeyId: string) => {
    ...
    await page.goto(`/${journeyId}/temporary-absence-authorisations/edit/enter-location`)
  }
  ...
  test('should manually enter an address', async ({ page }) => {
    ...
    // verify page content
    const testPage = await new EditTapAuthorisationEnterLocationPage(page).verifyContent()
