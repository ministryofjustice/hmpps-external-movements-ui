import { EditTapOccurrenceLocationController } from './controller'
...
export const EditTapOccurrenceLocationRoutes = ({ osPlacesAddressService, externalMovementsService }: Services) => {
  const { router, get, post } = BaseRouter()
  const controller = new EditTapOccurrenceLocationController(externalMovementsService)
