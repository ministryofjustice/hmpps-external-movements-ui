...
import { AbsenceTypePage } from './absence-type/tests.spec'
import { AbsenceSubTypePage } from './absence-subtype/tests.spec'
import { ReasonCategoryPage } from './reason-category/tests.spec'
import { AbsenceReasonPage } from './reason/tests.spec'
import { SingleOrRepeatingPage } from './single-or-repeating/tests.spec'
import { StartDatePage } from './start-date/tests.spec'
import { EndDatePage } from './end-date/tests.spec'
import { LocationTypePage } from './location-type/tests.spec'
import { AccompaniedOrUnaccompaniedPage } from './accompanied-or-unaccompanied/tests.spec'
import { AccompaniedPage } from './accompanied/tests.spec'
import { TransportPage } from './transport/tests.spec'
import { AbsenceApprovalPage } from './approval/tests.spec'
