...
test.describe('/add-temporary-absence/select-days-and-time unauthorised', () => {
  test('should show unauthorised error', async ({ page }) => {
    await testNotAuthorisedPage(page, `/${uuidV4()}/add-temporary-absence/select-days-and-time`)
  })
})
