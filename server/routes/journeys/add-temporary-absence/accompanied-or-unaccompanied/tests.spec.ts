...
test.describe('/add-temporary-absence/accompanied-or-unaccompanied unauthorised', () => {
  test('should show unauthorised error', async ({ page }) => {
    await testNotAuthorisedPage(page, `/${uuidV4()}/add-temporary-absence/accompanied-or-unaccompanied`)
  })
})
